...
export function StatusBreakdownInteractive({ orders }: StatusBreakdownInteractiveProps) {
  ...
  const chartData = React.useMemo(() => {
    ...
    // Initialize all dates in range with zero counts for all known statuses
    ...
    return (
      <Card>
        <CardHeader>
          ...
          <CardDescription>Distribution of your travel orders by status over time</CardDescription>
        </CardHeader>
      ...
      <CardHeader>
        ...
        <CardDescription>
          <span className="hidden @[540px]/card:block">
            Distribution of your travel orders by status over time
          </span>
